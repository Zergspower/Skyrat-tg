/datum/job/magistrate
	...
	description = "Ensure fair and just punishments or sentences are handed out, try not to let it go to your head."
	department_head = list(JOB_CENTCOM)
	faction = FACTION_STATION
	total_positions = 1
	spawn_positions = 1
	supervisors = "Nanotrasen Representative"
	selection_color = "#fc3d03"
