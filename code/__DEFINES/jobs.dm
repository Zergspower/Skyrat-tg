...
#define JOB_DISPLAY_ORDER_MAGISTRATE 46 //SKYRAT EDIT ADDITION
#define JOB_DISPLAY_ORDER_INTERNAL_AFFAIRS_AGENT 47 //SKYRAT EDIT ADDITION
...
#define DEPARTMENT_BITFLAG_LEGAL (1<<11) //SKYRAT EDIT ADDITION
#define DEPARTMENT_LEGAL "Legal" //SKYRAT EDIT ADDITION
