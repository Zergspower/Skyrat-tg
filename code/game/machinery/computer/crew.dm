...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		*/
		...
		JOB_MIME = 67,
		JOB_JANITOR = 68,
		// JOB_LAWYER = 69, temp hold removal until stars align
		JOB_BARBER = 71, // SKYRAT EDIT ADDITION
		JOB_BOUNCER = 72, // SKYRAT EDIT ADDITION
		// SKYRAT EDIT ADDITION - 80-85 Legal
		JOB_MAGISTRATE = 80, // SKYRAT EDIT ADDITION
		JOB_INTERNAL_AFFAIRS_AGENT = 81, // SKYRAT EDIT ADDITION
		JOB_LAWYER = 82, // SKRAY EDIT - ORIGINAL JOB_LAWYER = 69
		// 200-239: Centcom
